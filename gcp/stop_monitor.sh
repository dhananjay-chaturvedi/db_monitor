...
#   bash stop_monitor.sh --instance NAME [...]    # stop specific Cloud SQL instance loop(s)
...
Options:
  ...
  --instance NAME [...]      Stop the polling loop for one or more Cloud SQL instance(s)
...
Examples:
  ...
  bash stop_monitor.sh --instance my-cloudsql-instance
